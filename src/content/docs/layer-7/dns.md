...
2.  **Recursive Resolver**: (e.g., 1.1.1.1). Performs the lookup on behalf of the client. Caches results aggressively.
...
-   **CNAME**: Canonical Name. Maps hostname to hostname.
    ...
    -   *Cloudflare Solution*: **CNAME Flattening** allows CNAMEs at the root by resolving them to IPs at the edge.
