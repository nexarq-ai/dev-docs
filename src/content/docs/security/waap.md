...
### 1. DDoS Mitigation
-   **Volumetric Attacks (L3/L4)**: Flooding pipes with UDP/ICMP traffic (e.g., UDP Reflection).
...
-   **OWASP Top 10**: Standard awareness document (Injection, Broken Auth, XSS, etc.).
-   **Rule Sets**:
...
### 3. Bot Management
Distinguishing between Humans, Good Bots (Googlebot), and Bad Bots (Scrapers, Credential Stuffing).
...
### 4. API Security
APIs are the primary attack vector for modern apps.
