...
The protocol of the internet. It exchanges reachability information between **Autonomous Systems (AS)**. [What is BGP? (Cloudflare)](https://www.cloudflare.com/learning/security/glossary/what-is-bgp/).
...
### Anycast Routing
A network addressing and routing methodology where a single destination address has multiple routing paths to two or more endpoint destinations. [What is Anycast? (Cloudflare)](https://www.cloudflare.com/learning/cdn/glossary/anycast-cdn/).
